...
class DoctestCrate(
    ...
    override val rootModule: RsFile,
    ...
    override val rootModuleFile: VirtualFile? get() = rootModule.virtualFile
    ...
    override val defMap: CrateDefMap get() = TODO("Not yet implemented")
