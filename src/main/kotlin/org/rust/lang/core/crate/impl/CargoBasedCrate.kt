...
class CargoBasedCrate(
    ...
    override val rootModuleFile: VirtualFile? = cargoTarget.crateRoot
    override val id: CratePersistentId? = rootModuleFile?.fileId
    ...
    override val rootModule: RsFile? get() = rootModuleFile?.toPsiFile(cargoProject.project)?.rustFile
